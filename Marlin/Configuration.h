...
#define STRING_CONFIG_H_AUTHOR "Angus Cox" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "32bits SV01"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  18.28,  20.0 }
    #define DEFAULT_Ki_LIST {   1.35,   1.0 }
    #define DEFAULT_Kd_LIST { 61.77, 112.0 }
  #else
    #define DEFAULT_Kp  18.28
    #define DEFAULT_Ki   1.35
    #define DEFAULT_Kd 61.77
  #endif
#endif // PIDTEMP
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -35.5, -3.5, 0 }
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_INSET_LFRB { 50, 40, 50, 40 } // (mm) Left, Front, Right, Back insets
